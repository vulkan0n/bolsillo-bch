...
const translations = {
  ...
  ticketsAvailableNow: {
    ...
    bn: "টিকিট এখন পাওয়া যাচ্ছে",
    cy: "Tocynnau ar gael nawr",
    da: "Billetter tilgængelige nu",
    de: "Tickets sind ab sofort erhältlich.",
    el: "Εισιτήρια διαθέσιμα τώρα",
    en: "Tickets available now",
    es: "Entradas ya a la venta.",
    fa: "بلیط‌ها همین الان موجود است",
    fil: "Mabibili na ang mga tiket ngayon",
    fr: "Billets disponibles dès maintenant",
    ha: "Ana samun tikiti yanzu",
    hi: "टिकटें अब उपलब्ध हैं",
    id: "Tiket sudah tersedia sekarang.",
    it: "Biglietti disponibili ora",
    ja: "チケットは現在発売中です",
    jv: "Tiket kasedhiya saiki",
    ko: "티켓은 지금 구매 가능합니다.",
    mr: "तिकिटे आता उपलब्ध आहेत",
    ms: "Tiket tersedia sekarang",
    nb: "Billetter tilgjengelig nå",
    nl: "Tickets zijn nu verkrijgbaar.",
    pa: "ਟਿਕਟਾਂ ਹੁਣ ਉਪਲਬਧ ਹਨ",
    pl: "Bilety dostępne już teraz",
    pt: "Ingressos já disponíveis",
    ro: "Biletele sunt disponibile acum",
    ru: "Билеты уже в продаже!",
    sv: "Biljetter tillgängliga nu",
    sw: "Tikiti zinapatikana sasa",
    ta: "டிக்கெட்டுகள் இப்போது கிடைக்கின்றன",
    te: "టిక్కెట్లు ఇప్పుడు అందుబాటులో ఉన్నాయి",
    th: "ขณะนี้เปิดจำหน่ายบัตรแล้ว",
    tr: "Biletler şimdi satışta",
    uk: "Квитки вже доступні",
    ur: "ٹکٹیں ابھی دستیاب ہیں۔",
    vi: "Vé hiện đang được bán.",
    zh: "门票现已发售",
    zh_TW: "門票現已發售",
  },
  intro: {
