...
import { displaySatsAsUsd, satoshiBalanceToCurrencyDisplay } from "../../../../../utils/formatting";
...
function AvailableBalance() {
  ...
  const bchBalance = satoshiBalanceToCurrencyDisplay(wallet?.balance, bitcoinDenomination);
