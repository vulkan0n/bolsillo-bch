...
function BackupView({ navigation }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      <StackSubheader title={"Backup"} isBackButton />
      <ScrollView style={styles.scrollView}>
        <View style={styles.container as any}>
          ...
          <Text style={TYPOGRAPHY.pWhite as any}>
            It is recommended to make two backups of your phrase in safe
            locations such as a locked box or password manager. Do NOT store it
            as a screenshot!
          </Text>
          <Text style={TYPOGRAPHY.pWhite as any}>
          ...
          {!isMnemonicVisible && (
            <Button icon={"faEye"} onPress={toggleIsMnemonicVisible}>
              Reveal mnemonic
            </Button>
          )}
          {isMnemonicVisible && (
